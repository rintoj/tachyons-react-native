...
module.exports = {
  ...
  fw8: { fontWeight: '800' },
  fw9: { fontWeight: '900' },
  grow: { backfaceVisibility: 'hidden', transform: [{ translateZ: 0 }] },
  growActive: { transform: [{ scale: 0 }] },
  growLarge: { backfaceVisibility: 'hidden', transform: [{ translateZ: 0 }] },
  growLargeActive: { transform: [{ scale: 0 }] },
  h1: { height: 16 },
  h100: { height: '100%' },
  h2: { height: 32 },
  h25: { height: '25%' },
